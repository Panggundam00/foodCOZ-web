  ...
  if (querySnapshot){
    ...
    let password = querySnapshot.docs[0].data().Password
      if(username == this.state.inputemail && password == this.state.inputpassword){
        this.navigation.navigate('ManagerEditMenu', {User: this.state.inputemail})
      }
  }
}
        ...
        return (
          ...
          <Form.Control onChange={this.handlePasswordOnCharge} type="password" className="inputPlace" data-init/>
           ...
           <div>
             ...
             <div height="1000">
          <Button className="loginButton" variant="success" onClick={this.lOGIN} href={this.state.loginStatus}>LOG IN</Button>
